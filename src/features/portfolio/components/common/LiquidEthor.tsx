...
`;
    ...
    class Advection extends ShaderPass {
      ...
      update(...args: any[]) {
        ...
        if (typeof dt === "number") (this.uniforms as any).dt.value = dt;
        if (typeof isBounce === "boolean") this.line.visible = isBounce;
        if (typeof BFECC === "boolean")
          (this.uniforms as any).isBFECC.value = BFECC;
        super.update();
      }
    }
    ...
    class ExternalForce extends ShaderPass {
      ...
      update(...args: any[]) {
        ...
        const uniforms: any = (this.mouse.material as THREE.RawShaderMaterial)
          .uniforms;
    ...
    class Viscous extends ShaderPass {
      ...
      update(...args: any[]) {
        ...
        if (typeof viscous === "number")
          (this.uniforms as any).v.value = viscous;
        ...
        for (let i = 0; i < iter; i++) {
          ...
          (this.uniforms as any).velocity_new.value = fbo_in.texture;
    ...
    class Poisson extends ShaderPass {
      ...
      update(...args: any[]) {
        ...
        for (let i = 0; i < iter; i++) {
          ...
          if (this.uniforms)
            (this.uniforms as any).pressure.value = p_in.texture;
