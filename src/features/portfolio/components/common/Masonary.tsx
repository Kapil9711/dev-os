...
interface Item {
  id: string;
  img: string;
  url?: string; // was required
  height: number;
  label?: string; // NEW — skill name
  sublabel?: string; // NEW — category
}
  ...
  return (
    <div ref={containerRef} className="relative h-full w-full">
      {grid.map((item) => (
        ...
        >
          <div
            className="relative h-full w-full rounded-[10px] bg-cover bg-center text-[10px] uppercase leading-[10px] shadow-[0px_10px_50px_-10px_rgba(0,0,0,0.2)]"
